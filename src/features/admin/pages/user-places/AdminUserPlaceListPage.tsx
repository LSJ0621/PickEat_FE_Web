...
import { UserPlaceFilters } from '@features/admin/components/user-places/UserPlaceFilters';
import { UserPlaceList } from '@features/admin/components/user-places/UserPlaceList';
import { UserPlaceListSkeleton } from '@features/admin/components/user-places/UserPlaceListSkeleton';
import { UserPlaceDetailModal } from '@features/admin/components/user-places/UserPlaceDetailModal';
  ...
  return (
    <div className="relative flex min-h-screen items-start justify-center bg-bg-primary px-4 pt-20 pb-10 text-text-primary">
      ...
      <div className="relative z-10 w-full max-w-6xl">
        <div className="mb-6">
          <h1 className="mb-2 text-3xl font-bold text-text-primary">{t('admin.userPlaces.title')}</h1>
          <p className="text-text-tertiary">유저가 등록한 가게를 확인하고 승인/거절하세요.</p>
        </div>
