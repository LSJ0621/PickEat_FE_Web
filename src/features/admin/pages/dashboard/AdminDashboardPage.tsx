...
import { PendingAlert } from '@features/admin/components/dashboard/PendingAlert';
...
import type { DashboardSummary, RecentActivities, TrendData, TrendPeriod } from '@features/admin/types';
import { extractErrorMessage, handleApiError } from '@shared/utils/error';
