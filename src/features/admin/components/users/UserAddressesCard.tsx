            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <div className="mt-2 flex items-center gap-2">
                  {address.isDefault && (
                    <span className="flex items-center gap-1 rounded-full bg-pink-500/20 px-2 py-1 text-xs text-pink-600">
                      <Star className="h-3 w-3" />
                      기본 주소
                    </span>
                  )}
                  {address.isSearchAddress && (
                    <span className="flex items-center gap-1 rounded-full bg-blue-500/20 px-2 py-1 text-xs text-blue-600">
