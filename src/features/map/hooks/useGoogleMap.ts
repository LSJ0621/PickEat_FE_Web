...
import type { UseGoogleMapOptions, UseGoogleMapReturn, MapMarkerInfo } from '@features/map/types/googleMaps';
...
import { getLatLngFromRestaurant, createUserLocationMarkerContent } from '@shared/utils/googleMap';
...
export const useGoogleMap = (options: UseGoogleMapOptions): UseGoogleMapReturn => {
  ...
  const getLatLng = useCallback((restaurant: import('@features/map/types/search').Restaurant) => {
