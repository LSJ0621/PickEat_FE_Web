...
import { CheckRegistrationResult } from '@features/user-place/components/CheckRegistrationResult';
import { useUserPlaceCreate } from '@features/user-place/hooks/useUserPlaceCreate';
import type { CreateUserPlaceRequest, UpdateUserPlaceRequest } from '@features/user-place/types';
