...
export const UserPlaceFilters = ({
  ...
  return (
    <div className="rounded-lg border border-[var(--border-default)] bg-bg-surface p-4">
              ...
              <button
                ...
                className={`rounded-lg px-4 py-2 text-sm font-medium transition ${
                  status === option.value
                    ...
                    : 'border border-[var(--border-default)] bg-bg-surface text-text-secondary hover:bg-bg-hover'
                }`}
              >
                {option.label}
              </button>
        ...
        <div>
          ...
          <div className="flex gap-2">
            <input
              ...
              className="flex-1 rounded-lg border border-[var(--border-default)] bg-bg-surface px-4 py-2 text-text-primary placeholder-text-placeholder focus:border-brand-primary focus:outline-none focus:ring-2 focus:ring-brand-primary/20"
            />
            <button
              onClick={onReset}
