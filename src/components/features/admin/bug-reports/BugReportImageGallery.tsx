  ...
  return (
    <div className="space-y-3">
      ...
      <div className="relative">
        <div className="relative h-64 w-full overflow-hidden rounded-xl bg-bg-surface">
          <img
            src={images[currentImageIndex]}
            alt={t('bugReport.gallery.imageAlt', { index: currentImageIndex + 1 })}
            className={`h-full w-full object-contain transition-opacity duration-normal ${
            ...
            {images.map((imageUrl, index) => (
              ...
              >
                <img
                  ...
                  className="h-full w-full object-cover transition-opacity duration-normal"
                  loading="lazy"
                  decoding="async"
                />
              </button>
