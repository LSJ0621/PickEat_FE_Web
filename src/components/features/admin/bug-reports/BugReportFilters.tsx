...
export const BugReportFilters = ({
  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-wrap gap-4 rounded-lg border border-[var(--border-default)] bg-bg-surface p-4">
        {/* 상태 필터 */}
        ...
        <div className="flex items-end">
          <button
            onClick={onReset}
            className="rounded-lg border border-[var(--border-default)] bg-bg-surface px-4 py-2 text-sm text-text-secondary transition hover:bg-bg-hover"
          >
            {t('common.reset')}
          </button>
        </div>
      ...
      <div className="relative">
        <input
          ...
          className="w-full rounded-lg border border-[var(--border-default)] bg-bg-surface px-4 pl-10 py-3 text-text-primary placeholder-text-placeholder focus:border-brand-primary focus:outline-none focus:ring-2 focus:ring-brand-primary/20"
        />
