...
export function AdminListItem({ admin, currentUserId, onRemove }: AdminListItemProps) {
  ...
  return (
    <div className="flex items-center justify-between rounded-lg border border-[var(--border-default)] bg-bg-surface p-4 hover:bg-bg-hover transition-colors">
      <div className="flex items-center gap-4 flex-1">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 mb-1">
            ...
            {isCurrentUser && (
              <Badge variant="default" className="bg-gray-500 text-white text-xs">
                본인
              </Badge>
            )}
          </div>
