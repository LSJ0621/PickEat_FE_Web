...
export function AddAdminModal({ isOpen, onClose, onConfirm, isLoading }: AddAdminModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="bg-bg-surface border-[var(--border-default)] text-text-primary">
        <DialogHeader>
        ...
        <form onSubmit={handleSubmit}>
          <div className="space-y-4 py-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                className="bg-bg-surface border-[var(--border-default)] text-text-primary placeholder:text-text-placeholder"
                required
                disabled={isLoading}
              />
            ...
            <div className="space-y-2">
              ...
              <Select value={role} onValueChange={(value) => setRole(value as AdminRole)} disabled={isLoading}>
                <SelectTrigger className="bg-bg-surface border-[var(--border-default)] text-text-primary">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent className="bg-bg-surface border-[var(--border-default)] text-text-primary">
          ...
          <DialogFooter>
            <Button
              ...
              disabled={isLoading}
              variant="outline"
              className="bg-bg-surface border-[var(--border-default)] text-text-primary hover:bg-bg-hover"
            >
              취소
            </Button>
            <Button
