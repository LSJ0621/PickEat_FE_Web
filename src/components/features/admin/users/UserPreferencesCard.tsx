  ...
  if (!preferences || (!preferences.likes.length && !preferences.dislikes.length)) {
    return (
      <div className="rounded-lg border border-slate-700 bg-slate-900/50 p-6">
        <h2 className="mb-6 text-xl font-bold text-white">선호도</h2>
        <div className="text-center text-slate-400 py-8">등록된 선호도 정보가 없습니다.</div>
      </div>
    );
  }
        ...
        {preferences.likes.length > 0 && (
          <div>
            <div className="flex items-center gap-2 mb-3">
              ...
              <h3 className="font-semibold text-white">좋아하는 음식</h3>
            </div>
        ...
        {preferences.dislikes.length > 0 && (
          <div>
            <div className="flex items-center gap-2 mb-3">
              ...
              <h3 className="font-semibold text-white">싫어하는 음식</h3>
            </div>
            <div className="flex flex-wrap gap-2">
