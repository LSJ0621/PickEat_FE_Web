...
export const AiPlaceRecommendations = ({
  ...
  const renderRecommendationGroups = (groups: MenuPlaceRecommendationGroup[], sectionPrefix: string, showRating = true) => {
        ...
        <div className="mt-5 space-y-5">
          ...
          {(hasSearchRecommendations || finalSearchLoading) && (
            <section className="space-y-3">
              ...
              <div className="space-y-3">
                {renderRecommendationGroups(searchVisibleGroups, 'search', false)}
          ...
          {(hasCommunityRecommendations || finalCommunityLoading) && (
            <section className="space-y-3">
              ...
              <div className="space-y-3">
                {renderRecommendationGroups(communityVisibleGroups, 'community', true)}
          ...
          {!hasSearchRecommendations &&
            ...
            hasRecommendations && (
              <div className="space-y-3">
                {renderRecommendationGroups(visibleGroups, 'legacy', true)}
