...
import { usePlaceSelection } from '@/hooks/agent/usePlaceSelection';
...
const PlaceDetailsModal = lazy(() =>
  import('@/components/features/restaurant/PlaceDetailsModal').then((m) => ({
    default: m.PlaceDetailsModal,
  }))
);

const PlaceSelectionModal = lazy(() =>
  import('@/components/features/restaurant/PlaceSelectionModal').then((m) => ({
